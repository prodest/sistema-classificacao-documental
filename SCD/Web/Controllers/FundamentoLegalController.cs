...
namespace Web.Controllers
{
    ...
    public class FundamentoLegal : BaseController
    {
        IFundamentoLegalService _service;

        public FundamentoLegal(IFundamentoLegalService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Create(FundamentoLegalViewModel model)
        {
            var modelForm = model;
        ...
        public async Task<IActionResult> Update(FundamentoLegalViewModel model)
        {
            if (model != null && model.entidade != null)
            {
