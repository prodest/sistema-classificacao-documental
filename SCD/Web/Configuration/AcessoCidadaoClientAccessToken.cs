...
namespace Prodest.Scd.Web.Configuration
{
    public class AcessoCidadaoClientAccessToken : IClientAccessTokenProvider
    {
        ...
        private readonly IOptions<AcessoCidadaoConfiguration> _autenticacaoIdentityServerConfig;
        ...
        {
            AcessoCidadaoConfiguration acessoCidadaoConfiguration = _autenticacaoIdentityServerConfig.Value;

            TokenClient tokenClient = new TokenClient(acessoCidadaoConfiguration.Authority + "/connect/token", _clientId, _secret);
